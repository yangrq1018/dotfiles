# Generated by Powerlevel10k configuration wizard on 2024-01-12 at 04:20 CST.
...
() {
  ...
  # If you do not set this, a default expansion is used, so it will always be visible.
